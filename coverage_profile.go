...
// It also sorts items in ascending order of file path and starting line number.
func (cp CoverageProfile) GetUniqueBlocks() []CodeBlockCoverage {
	...
	sort.Slice(ret, func(i, j int) bool {
		b0 := ret[i]
		b1 := ret[j]
		return (b0.CodeRange.FilePath < b1.CodeRange.FilePath) ||
			(b0.CodeRange.FilePath == b1.CodeRange.FilePath && b0.CodeRange.StartLine < b1.CodeRange.StartLine)
	})
	return ret
}
